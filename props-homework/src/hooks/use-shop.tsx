...
import { ProductInTheCartEntity, ProductInTheCatalogueEntity } from "../entites/product-entity";
...
type ShopState = {
    ...
    products: {
        byId: {[id: string]: ProductInTheCatalogueEntity}
        allIds: string[]
    }
}

const productsSample: {[id: string]: ProductInTheCatalogueEntity}= {
    "1": {
        name: "Product 1",
        amount: 10,
        id: "1",
...
function selectProductById(state: ShopState, id :string): ProductInTheCatalogueEntity {
...
function selectAllProductsInTheCart(state: ShopState): ProductInTheCartEntity[] {
    const products: ProductInTheCartEntity[] = [];

    state.cart.products.forEach(id => {
        const index = products.findIndex((product: ProductInTheCartEntity) => product.id === id);
...
export function useShop() {
    ...
    return {
        ...
        doAddNewProduct: (product: ProductInTheCatalogueEntity) => dispatch({
